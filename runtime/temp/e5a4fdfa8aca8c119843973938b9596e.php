<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/var/www/html/tp5/public/../application/admin/view/login/login.htm";i:1555392985;}*/ ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml"><!--Head--><head>
    <meta charset="utf-8">
    <title>欢迎登陆个人博客管理系统</title>
    ...
    <div class="login-container animated fadeInDown">
        <form action="" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="logobox">
                    <p class="text-center">欢迎登陆个人博客管理系统</p>
                </div>
        </form>
    </div>
    <!--Basic Scripts-->
